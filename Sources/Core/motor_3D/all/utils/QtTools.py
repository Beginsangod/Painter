...
class QPathSelector(QWidget):
    ...
    def select_path(self):
        ...
        path, _ = QtWidgets.QFileDialog.getOpenFileName(self, "Choisissez un chemin", options=options)
...
class QDirectorySelector(QWidget):
    ...
    def select_path(self):
        options = QtWidgets.QFileDialog.Options()
        options |= QtWidgets.QFileDialog.DontUseNativeDialog
        dir = QtWidgets.QFileDialog.getExistingDirectory(self, "Choisissez un dossier", options=options)
...
class QMenu(QWidget):
    ...
    def __init__(self, parent, menu_list: list, type="v"):
        ...
        for menu_item in self.menu_list:
            button = QtWidgets.QPushButton(menu_item) 
