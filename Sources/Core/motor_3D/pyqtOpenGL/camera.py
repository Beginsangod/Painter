...
class Camera:
    ...
    def __init__(
        ...
        """
        self.pos = Vector3(position)  # The vector from the origin of the world coordinate system to the camera position, expressed in the camera coordinate system.
    ...
    def get_view_pos(self):
        """Compute the camera's position in the world coordinate system"""
